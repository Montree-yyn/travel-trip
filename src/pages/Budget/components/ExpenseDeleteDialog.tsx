...
import { Button, GlassCard, ModalPortal } from "@/components/ui";
          ...
          >
            ...
            >
              ...
              <div className="space-y-1.5">
                <h2 className="text-lg font-semibold text-ink">{t("budget.deleteExpense")}</h2>
                <p className="text-sm leading-relaxed text-ink-muted">
                  {t("budget.deleteConfirm", { title: expense.title })}
                </p>
              </div>
